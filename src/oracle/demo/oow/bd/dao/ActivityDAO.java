...
//        activityBinding = catalog.getJsonBinding(activitySchema);
    ...
    public List<MovieTO> getCustomerBrowseList1(int custId){
    	List<MovieTO> movieList = new ArrayList<MovieTO>();
    	ActivityTO activityTO=null;
    	TableInfo tableInfo=new TableInfo("info", "custId",String.valueOf(custId));
    	List<Result> results = HbaseUtil.singleColumnValueFilter("activity", tableInfo);
    	Iterator<Result> result = results.iterator();
    	while(result.hasNext())
    	{
    		Result r = result.next();
    		String jsonStr =HbaseUtil.resultToJsonString(r);
    		System.out.println(r);
    		System.out.println(jsonStr);
    		activityTO = new ActivityTO(jsonStr);
    	}
    	return movieList;
    }
    ...
    public static void main(String[] args) {
        ...
        int custId=1001640;
        aDAO.getCustomerBrowseList1(custId);
