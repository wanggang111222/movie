...
import oracle.demo.oow.bd.util.TableInfo;
...
//            }
    ...
    private void getMovie(Row row, List<MovieTO> movieTOList){
        ...
        TableInfo tableInfo = new TableInfo("info", "tableId","CT_BL");
        TableInfo tableInfo1 = new TableInfo("info", "custId",String.valueOf(activityTO.getCustId()));
        TableInfo tableInfo2 = new TableInfo("info", "movieId",String.valueOf(activityTO.getMovieId()));
        TableInfo tableInfo3 = new TableInfo("info", "genreId",String.valueOf(activityTO.getGenreId()));
        TableInfo tableInfo4 = new TableInfo("info", "activity",String.valueOf(activityTO.getActivity()));
        TableInfo tableInfo5 = new TableInfo("info", "recommended",String.valueOf("Y"));
        TableInfo tableInfo6 = new TableInfo("info", "time",String.valueOf(activityTO.getFormattedTime()));
        TableInfo tableInfo7 = new TableInfo("info", "rating",String.valueOf(activityTO.getRating()));
        TableInfo tableInfo8 = new TableInfo("info", "price",String.valueOf(activityTO.getPrice()));
        TableInfo tableInfo9 = new TableInfo("info", "position",String.valueOf(activityTO.getPosition()));
        tableInfos.add(tableInfo);
        tableInfos.add(tableInfo1);
        tableInfos.add(tableInfo2);
        tableInfos.add(tableInfo3);
        tableInfos.add(tableInfo4);
        tableInfos.add(tableInfo5);
        tableInfos.add(tableInfo6);
        tableInfos.add(tableInfo7);
        tableInfos.add(tableInfo8);
        tableInfos.add(tableInfo9);
        HbaseUtil.put("activity", String.valueOf(i), tableInfos);
        i++;*/
        /**********8*/
